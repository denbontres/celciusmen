    ...
    var Controller = (function (uiCtr){
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/User/getJenis'?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "id",
                    "orderable": false,
      ...
      function hapus(id) {
        $.ajax({
          type:'POST',
          data:{id:id},
          url:"<?=base_url('admin/User/deleteJenisUser')?>",
          dataType:'JSON',
      ...
      function insert(){
        ...
        $.ajax({
          type:'POST',
          data:form_data,
          url:base_url+"admin/User/insertJenisUser",
          processData: false,
          contentType: false,
          dataType:"JSON",
          success:function(data){
      ...
      function ambilData(id){
        $.ajax({
          type:'POST',
          data:'id='+id,
          url:"<?=base_url('admin/User/ambilByIDJenis')?>",
          dataType:'JSON',
          success:function(data){
            $('#id').val(data['id']);
