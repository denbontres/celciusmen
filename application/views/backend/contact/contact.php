      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <a href="<?=base_url('admin/Blog/insert')?>" class="btn btn-info mb-2"><i class="fas fa-plus mr-2"></i>Add</a>
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Contact/getContact'?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "id",
                    "orderable": false,
