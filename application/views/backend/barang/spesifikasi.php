  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?=$judul.' '.$namaBarang ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="modal-body">
              <form method="POST" id="form">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="idBarang" id="idBarang" value="<?=$barang?>" style="display:none">
                  <small class="text-danger" id="error-nama"></small>
                </div>
                <div class="form-group">
                  Nilai
                  <input type="text" class="form-control" name="nilai" id="nilai">
                  <small class="text-danger" id="error-nilai"></small>
                </div>
            </div>
  ...
  <script>
    ...
    var Controller = (function (uiCtr){
      ...
      var setupEventListener = function(){
        ...
        $(dom.nilai).on('change',function(){
          uiCtr.bersihError(dom.errorNilai);
        });
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Spesifikasi/getSpesifikasi/'.$barang?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "id",
                    "orderable": false,
      ...
      function hapus(id) {
        $.ajax({
          type:'POST',
          data:{id:id},
          url:"<?=base_url('admin/Spesifikasi/deleteSpesifikasi')?>",
          dataType:'JSON',
      ...
      function insert(){
        ...
        $.ajax({
          type:'POST',
          data:form_data,
          url:base_url+"admin/Spesifikasi/insertSpesifikasi",
          processData: false,
          contentType: false,
          dataType:"JSON",
          success:function(data){
            if(data.pesan == "Berhasil"){
              ...
              uiCtr.tampilError(dom.errorNilai,data.errornilai);
            }
          }
        });
      }
      ...
      function ambilData(id){
        $.ajax({
          type:'POST',
          data:'id='+id,
          url:"<?=base_url('admin/Spesifikasi/ambilByIDSpesifikasi')?>",
          dataType:'JSON',
          success:function(data){
            $('#id').val(data['id']);
            uiCtr.isiKolom(dom.nama,data['nama']);
            uiCtr.isiKolom(dom.nilai,data['nilai']);
          }
        });
      }
