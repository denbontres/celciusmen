      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form action="<?=base_url('admin/Barang/editBarang/'.$barang['id'])?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            Nama Barang
                            <input type="text" class="form-control" name="nama" id="nama-barang" value="<?=$barang['nama']?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis" id="jenis" class="form-control">
                                <?php foreach($jenis as $r):?>
                                    <option value=<?=$r['id']?> <?=$barang['id_jenis_barang']==$r['id']?'selected':''?>> <?=$r['nama']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="kategori" id="kategori" class="form-control">
                                ...
                                <option value=<?=$r['id']?>  <?=$barang['id_kategori_barang']==$r['id']?'selected':''?>> <?=$r['nama']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                        <div class="form-group">
                            Berat
                            <input type="text" class="form-control rupiah" name="berat" id="berat" value="<?=$barang['berat']?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            Harga
                            <input type="text" class="form-control rupiah" name="harga" id="harga-barang" value="<?=$barang['harga']?>">
                            <?= form_error('harga','<small class="text-danger pl-3" id="error-harga">','</small>');?>
                        </div>
                        <div class="form-group">
                            Diskon
                            <input type="number" max=100 min=0 class="form-control" name="diskon" id="diskon" value="<?=$barang['diskon']?>">
                            <?= form_error('diskon','<small class="text-danger pl-3" id="error-diskon">','</small>');?>
                        </div>
                        <div class="form-group">
                            Total Harga
                            <input type="text" class="form-control rupiah" name="total" id="total" value="<?=$barang['total_harga']?>" disabled>
                        </div>
                        <div class="form-group">
                            Brand
                            <input type="text" class="form-control" name="brand" id="brand" value="<?=$barang['brand']?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            Deskripsi
                            <textarea name="deskripsi" class ="form-control" id="deskripsi" cols="30" rows="6"><?=$barang['deskripsi']?></textarea>
                            <?= form_error('deskripsi','<small class="text-danger pl-3" id="error-deskripsi">','</small>');?>
                        </div>
                        <div class="form-group">
                            Deskripsi Singkat
                            <textarea name="deskripsi-singkat" class ="form-control" id="deskripsi-singkat" cols="30" rows="6"><?=$barang['short_deskripsi']?></textarea>
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                              <div class="col-md-5">
                                  <img id="show" src="<?=$barang['foto']?base_url('resource/'.$barang['foto']):base_url('resource/blank.jpg')?>" alt="your image" class="mb-2" width="130" height="150"/><br>
                                  <input type="file" name="foto" id="foto"><br>
                                  <?= form_error('foto','<small class="text-danger pl-3" id="error-foto">','</small>');?>
                              </div>
                              <div class="col-md-5">
                                  <img id="show2" src="<?=$barang['foto2']?base_url('resource/'.$barang['foto2']):base_url('resource/blank.jpg')?>" alt="your image" class="mb-2" width="130" height="150"/><br>
                          ...
                          <div class="row mt-5 mb-3">
                              <div class="col-md-5">
                                  <img id="show3" src="<?=$barang['foto3']?base_url('resource/'.$barang['foto3']):base_url('resource/blank.jpg')?>" alt="your image" class="mb-2" width="130" height="150"/><br>
                                  <input type="file" name="foto3" id="foto3"><br>
                                  <?= form_error('foto3','<small class="text-danger pl-3" id="error-foto3">','</small>');?>
                              </div>
                              <div class="col-md-5">
                                  <img id="show4" src="<?=$barang['foto4']?base_url('resource/'.$barang['foto4']):base_url('resource/blank.jpg')?>" alt="your image" class="mb-2" width="130" height="150"/><br>
                          ...
                          <div class="form-group mt-3">
                              Tag
                              <input type="text" class="form-control" name="tag" id="tag" value="<?=$barang['tag']?>">
