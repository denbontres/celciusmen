    ...
    var Controller = (function (uiCtr){
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/KategoriBarang/getKategori'?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "id",
                    "orderable": false,
      ...
      function hapus(id) {
        $.ajax({
          type:'POST',
          data:{id:id},
          url:"<?=base_url('admin/KategoriBarang/deleteKategoriBarang')?>",
          dataType:'JSON',
      ...
      function insert(){
        ...
        $.ajax({
          type:'POST',
          data:form_data,
          url:base_url+"admin/KategoriBarang/insertKategoriBarang",
          processData: false,
          contentType: false,
          dataType:"JSON",
          success:function(data){
      ...
      function ambilData(id){
        $.ajax({
          type:'POST',
          data:'id='+id,
          url:"<?=base_url('admin/Kategori/ambilByIdKategoriBarang')?>",
          dataType:'JSON',
          success:function(data){
            $('#id').val(data['id']);
