            ...
            <div class="modal-body">
              <form method="POST" id="form">
                ...
                <div class="form-group">
                  ...
                  <small class="text-danger" id="error-asal"></small>
                </div>
                <div class="form-group">
                  Status
  ...
  <script>
    ...
    var Controller = (function (uiCtr){
      ...
      var setupEventListener = function(){
        ...
        $(dom.asal).on('change',function(){
          uiCtr.bersihError(dom.errorAsal);
        });
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Pengunjung/getPengunjung'?>", "type": "POST"},
                columns: [                     
                  {
                    "data": "id",
                    "orderable": false,
      ...
      function hapus(id) {
        $.ajax({
          type:'POST',
          data:{id:id},
          url:"<?=base_url('admin/Pengunjung/deletePengunjung')?>",
          dataType:'JSON',
      ...
      function insert(){
        ...
        $.ajax({
          type:'POST',
          data:form_data,
          url:base_url+"admin/Pengunjung/insertPengunjung",
          processData: false,
          contentType: false,
          dataType:"JSON",
          success:function(data){
            if(data.pesan == "Berhasil"){
              ...
              uiCtr.tampilError(dom.errorAsal,data.errorasal);
            }
          }
        });
      }
      ...
      function ambilData(id){
        $.ajax({
          type:'POST',
          data:'id='+id,
          url:"<?=base_url('admin/Pengunjung/ambilByIDPengunjung')?>",
          dataType:'JSON',
          success:function(data){
            $('#id').val(data['id']);
            uiCtr.isiKolom(dom.nama,data['nama']);
            uiCtr.isiKolom(dom.alamat,data['alamat']);
            uiCtr.isiKolom(dom.asal,data['asal']);
            uiCtr.isiKolom(dom.status,data['id_status']);
          }
        });
      }
