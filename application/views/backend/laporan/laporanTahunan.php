    ...
    var Controller = (function (uiCtr){
      ...
      var setupEventListener = function(){
        ...
        $(dom.cetak).on('click',function(){
          var tahun = $('#tahun').val();
          url = base_url + 'admin/Laporan/CetakLaporanTahunan/'+tahun;
      ...
      function getTotal(){
        ...
        $.ajax({
          type:'POST',
          data:{tahun},
          url:base_url+"admin/Laporan/getTotalTahun",
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          ...
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Laporan/getLaporanTahunan'?>", "type": "POST","data":{'tahun':tahun},'dataType':'json',
