    ...
    var Controller = (function (uiCtr){
      ...
      function getTotal(){
        ...
        $.ajax({
          type:'POST',
          data:{tanggal},
          url:base_url+"admin/Laporan/getTotalByTanggal",
      ...
      function tampilTabel(){
        ...
        table = $("#tabel").dataTable({
          ...
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Laporan/getLaporanByTanggal'?>", "type": "POST","data":{'tanggal':tanggal},'dataType':'json',
          },
                columns: [                     
                  {
                    "data": "nofaktur",
