    ...
    var Controller = (function (uiCtr){
      ...
      var setupEventListener = function(){
        ...
        $(dom.cetak).on('click',function(){
          var tahun = $('#tahun').val();
          var bulan = $('#bulan').val();
          url = base_url + 'admin/Laporan/cetakLaporanBulanan/'+bulan+'/'+tahun;
          window.open(url, '_blank'); 
        });
      }

      function getTotal(bulan,tahun){
        $.ajax({
          type:'POST',
          data:{tahun,bulan},
          url:base_url+"admin/Laporan/getTotalBulan",
      ...
      function tampilTabel(bulan,tahun){
        ...
        table = $("#tabel").dataTable({
          ...
          initComplete: function() {
              ...
              processing: true,
              serverSide: true,
              ajax: {"url": "<?php echo base_url().'admin/Laporan/getLaporanBulanan'?>", "type": "POST","data":{'bulan':bulan,'tahun':tahun},'dataType':'json',
