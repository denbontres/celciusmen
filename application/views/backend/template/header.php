...
<head>
  ...
  <link rel="shortcut icon" href="<?=base_url('asset/backend/')?>dist/img/favicon.png" type="image/x-icon">
  <!-- Font Awesome -->
  ...
  <!-- JQVMap -->
  <link rel="stylesheet" href="<?=base_url('asset/backend/')?>plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
