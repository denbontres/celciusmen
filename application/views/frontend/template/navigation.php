        ...
        <div class="container-fluid"><a class="navbar-brand d-sm-flex align-items-sm-center" href="index.html"><img src="<?=base_url('asset/frontend/assets/')?>img/logo.png"></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item px-2" role="presentation"><a class="nav-link" href="<?=base_url('explore')?>" style="font-size: 14px;"><strong>EXPLORE</strong></a></li>
                    ...
                    <?php } ?> 
                    <li class="nav-item pl-2" role="presentation" data-toggle="tooltip" data-bs-tooltip="" data-placement="bottom" title="Shopping bag"><a class="nav-link d-md-flex align-items-md-center" href="<?=base_url('Cart')?>"><i class="icon-bag"></i><span class="badge badge-pill badge-light cart-amunt" display="absolute">0</span></a></li>
                    <li class="nav-item d-lg-flex align-items-lg-center px-2"
                        ...
                        <form action="<?=base_url('catalog')?>" method="GET">
                                    <input type="text" name="search" placeholder="What do you need?" value="<?=$this->input->get('search');?>">
