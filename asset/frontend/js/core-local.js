var base_url = "http://localhost/celciusmen032421/";  
                    ...
                    html +='<div class="row">'+
                            ...
                            '<div class="col itemlist-desc py-2"><a class="prod-title" href="#go to product">'+nama+'</a>'+
                                ...
                                '<div class="price-item-list">'+
                                    '<p class="normal-price-item-list">IDR '+harga+'</p>'+
                                '</div>'+
                                '<div class="quantity">'+
                                    '<div class="pro-qty">'+
                                        '<span class="dec qtybtn" id="min" data-id="'+id+'"'+'data-harga='+harga+'>-</span><input type="text" value="'+jumlah+'"><span class="inc qtybtn" id="plush" data-id="'+id+'"'+'data-harga='+harga+'>+</span>'+
                                    '</div>'+
                                '</div>'+
                                '<div class="price-item-list">'+
                                    '<p class="normal-price-item-list">Total : IDR '+subtotal+'</p>'+
                                '</div>'+
        ...
        function hapusItemWishlist(id){
            $.ajax({
                ...
                success:function(data){
                    getJumlahWishList();
                    getDataWishlist();
                    if(location.pathname.substring(1)=="celciusmen032421/Wishlist"){
                        getAllWishlist();
                    }
                }
            });
        ...
        function hapusItemKeranjang(id){
            $.ajax({
                ...
                success:function(data){
                    ...
                    getTotalBelanja();
                    getDataBelanja();  
                    if(location.pathname.substring(1)=="celciusmen032421/Cart"){
                        getAllPemesanan();
                        get_pemesanan()                      
                    }
                }
